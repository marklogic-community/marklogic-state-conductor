...
test.loadTestFile('test-wait-job.asl.json', xdmp.database(sc.STATE_CONDUCTOR_JOBS_DB), '/stateConductorJob/test-wait-job.json', xdmp.defaultPermissions(), [sc.JOB_COLLECTION, "unitTest"])
