...
The "contextual-flow" does this three times, and passes a new uri via context each time.
...
jobDoc = xdmp.toJSON({
  id: sem.uuidString(),
  flowName: "contextual-flow",
  flowStatus: "working",
  flowState: "createDoc1",
  uri: doc1Uri,
...
assertions.push(
  test.assertEqual(JSON.stringify(doc2Obj.old), JSON.stringify(doc1Obj), "new document was created using context")
);
...
// make sure doc3 was created
assertions.push(
  test.assertEqual(JSON.stringify(doc3Obj.old.old), JSON.stringify(doc1Obj), "new document was created using context")
);
...
assertions.push(
  test.assertEqual(JSON.stringify(doc4Obj.old.old.old), JSON.stringify(doc1Obj), "new document was created using context")
);
