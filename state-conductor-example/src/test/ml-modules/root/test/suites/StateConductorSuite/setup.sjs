...
xdmp.documentAddCollections('/data/test-doc2.json', [
  sc.FLOW_ITEM_COLLECTION,
  'test',
]);
xdmp.documentAddCollections('/data/test-doc3.json', [
  sc.FLOW_ITEM_COLLECTION,
  'enrollee',
]);
xdmp.documentAddCollections('/data/test-doc4.json', [
  sc.FLOW_ITEM_COLLECTION,
  'waitStateTest',
]);
