...
assertions.push(test.assertEqual(sc.MAX_RETRY_ATTEMPTS, assertion.retries["States.ALL"],  "below-all"));
assertions.push(test.assertEqual(sc.MAX_RETRY_ATTEMPTS, assertion.provenance[0]["retryNumber"],  "below-number"));
...
assertions.push(test.assertEqual(sc.MAX_RETRY_ATTEMPTS, assertion.retries["States.ALL"],  "limit-all"));
...
assertions.push(test.assertEqual(sc.MAX_RETRY_ATTEMPTS + 10, assertion.retries["States.ALL"],  "limitMore-all"));
...
assertions.push(test.assertEqual(4, assertion.provenance[0]["retryNumber"], "MaxAttemptsSet-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "MaxAttemptsSet-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.fourMaxAttempts.name,  "MaxAttemptsSet-error"));
...
assertions.push(test.assertEqual(2, assertion.provenance[0]["retryNumber"], "multipleMatch-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleMatch-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMatch.name,  "multipleMatch-error"));
...
assertions.push(test.assertEqual(1, assertion.provenance[0]["retryNumber"], "multipleMatchMax-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleMatchMax-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMatch.name,  "multipleMatchMax-error"));
...
assertions.push(test.assertEqual("error", assertion.errors.multipleMatch.name,  "multipleMatchMaxALL-error"));
...
assertions.push(test.assertEqual(2, assertion.provenance[0]["retryNumber"], "multipleOnRetry-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleOnRetry-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleOnRetry.name,  "multipleOnRetry-error"));
...
assertions.push(test.assertEqual(2, assertion.retries["error,*,States.ALL"], "multipleMultiple-all"));
assertions.push(test.assertEqual(2, assertion.provenance[0]["retryNumber"], "multipleMultiple-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleMultiple-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMultiple.name,  "multipleMultiple-error"));
...
assertions.push(test.assertEqual(4, assertion.retries["error,*,States.ALL"], "multipleMultipleMax-all"));

assertions.push(test.assertEqual("failed", assertion.flowStatus,   "multipleMultipleMax-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMultiple.name,  "multipleMultipleMax-error"));
...
assertions.push(test.assertEqual(2, assertion.retries["error,*,States.ALL"], "multipleMultipleMatch-all"));
assertions.push(test.assertEqual(2, assertion.provenance[0]["retryNumber"], "multipleMultipleMatch-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleMultipleMatch-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMultipleMatch.name,  "multipleMultipleMatch-error"));
...
assertions.push(test.assertEqual(4, assertion.retries["error,*,States.ALL"], "multipleMultipleMatchMax-all"));
assertions.push(test.assertEqual(1, assertion.retries["States.ALL"], "multipleMultipleMatchMax-all"));

assertions.push(test.assertEqual(1, assertion.provenance[0]["retryNumber"], "multipleMultipleMatchMax-number"));
assertions.push(test.assertEqual("working", assertion.flowStatus,   "multipleMultipleMatchMax-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMultipleMatch.name,  "multipleMultipleMatchMax-error"));
...
assertions.push(test.assertEqual(4, assertion.retries["error,*,States.ALL"], "multipleMultipleMatchMaxALL-all"));
assertions.push(test.assertEqual(4, assertion.retries["States.ALL"], "multipleMultipleMatchMaxALL-all"));

assertions.push(test.assertEqual("failed", assertion.flowStatus,   "multipleMultipleMatchMaxALL-flowStatus"));
assertions.push(test.assertEqual("error", assertion.errors.multipleMultipleMatch.name,  "multipleMultipleMatchMaxALL-error"));
